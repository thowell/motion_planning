...
# foot_1_z = [0.0 for t = 1:T]#sqrt.((zh^2.0) * (1.0 .- ((foot_1_x .- abs(foot_1_T[1] / 2.0)).^2.0)
...
obj_control_velocity = control_velocity_objective(Diagonal([0.0 * ones(model.nu); 0.0 * ones(model.m - model.nu)]))
